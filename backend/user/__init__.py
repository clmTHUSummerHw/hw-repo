...
from user.get_all_project import get_all_project
...
user_api.add_url_rule('/get-all-project', view_func=get_all_project, methods=['POST'])
user_api.add_url_rule('/get-logs', view_func=get_logs, methods=['POST'])