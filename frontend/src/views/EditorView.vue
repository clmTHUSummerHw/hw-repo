            ...
            <el-container id="content">
                <el-aside id="BOX_PROJECT_FILE_LIST">
                    <div class="uploadhide">
                        <el-upload ref="upload" :auto-upload="false" :on-change="uploadFile" :show-file-list="false">
                            <template #trigger>
                                <el-button type="primary" class="uploadButton">select file</el-button>
                            </template>
                        </el-upload>
                    </div>
                    <el-menu mode="vertical" v-show="menuVisible" class="contextmenu" @select="handleContextmenu">
                    ...
                    <!--当前项目文件栏-->
                    <el-tree ref="tree" :data="treeData" :props="treeProps" node-key="id"
                        :default-expanded-keys="expandedTreeId" @node-click="handleNodeClick" highlight-current="true"
                        @node-contextmenu="handleNodeContextmenu">
                        <template #default="{ node, data }">
                            <img src="~@/assets/icon-folder-close.svg" id="folder_close"
                                v-if="!node.expanded && data.folder" />
                            <img src="~@/assets/icon-folder-open.svg" id="folder_open"
                ...
                <el-main id="BOX_FILE_EDITOR">
                    <!--编辑器空间-->
                    <el-tabs v-model="active_name" type="border-card" editable @edit="handleTabsEdit"
                        @tab-change="handleTabChange" closable>
